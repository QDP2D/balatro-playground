...
function DiscardsCard() {
    ...
    return (
        <div className="basis-1/2 bg-gray-900 flex flex-col rounded">
            ...
            <div className="basis-3/4 bg-gray-700 content-center grid grid-cols-4 mb-1 ml-1 mr-1 rounded text-red-300 text-2xl">
                <div className="col-span-3 self-center">{remainingDiscards}</div>
